...
man_who_knew_infi = media.Movie("Man who knew infinity",
                            "In 1913, brilliant South Indian mathematician Srinivasa Ramanujan (Dev Patel) travels to Trinity College in England to work with professor G.H. Hardy (Jeremy Irons).",
...
movies = [avatar, logan, infinity_war, pacific_rim,sherlock_gnomes,tomb_raider, social_network, theory_of_everything, man_who_knew_infi]
