...
pacific_rim = media.Movie("Pacific Rim Uprising",
                          ...
                          Steven S. DeKnight (in his feature-film directorial debut) ''',
...
social_network = media.Movie("Social Network",
                             ...
                             relationship apart even as Facebook connects people.''',
...
theory_of_everything = media.Movie("Theory of Everything",
                                   ...
                                   learns that he suffers from motor neurone disease and has around two years to live''',
...
man_who_knew_infi = media.Movie("Man who knew infinity",
                                '''In 1913, brilliant South Indian mathematician Srinivasa Ramanujan (Dev Patel) travels to
                                Trinity College in England to work with professor G.H. Hardy (Jeremy Irons).''',
                                "http://t3.gstatic.com/images?q=tbn:ANd9GcRnrHiztFl1UMUDq1g8zajTENn9H9MsPA56Zh3aprKc3JEzQcIs",
